...
{
    public class BulkLoadDailyTrades : BaseBulkLoad, IDisposable
    {
        ...
        public BulkLoadDailyTrades()
            : base(ColumnNames)
        {

        }

        public DataTable LoadDataTableWithDailyTrades(IEnumerable<DailyTrade> dStats, DataTable dt)
        {
